...
(global-set-key (if *is-a-mac* (kbd "C-@") (kbd "C-'")) 'er/expand-region)
...
(setq evil-define-state 'emacs)
;; (define-key evil-emacs-state-map (kbd "C-c v") 'evil-execute-in-normal-state)
